...
uint8_t RemoteXY_CONF[] =   // 254 bytes
  { 255,10,0,22,0,247,0,19,0,0,0,99,103,50,50,55,49,32,40,66,
  108,117,101,116,111,111,116,104,41,0,27,1,200,84,1,1,17,0,1,28,
  52,23,23,8,24,31,226,150,189,0,1,28,22,23,23,8,24,31,226,150,
  179,0,129,64,7,74,11,192,3,77,111,116,111,114,32,67,111,110,116,114,
  111,108,115,0,1,123,57,23,23,8,24,31,226,151,129,0,1,158,57,23,
  23,8,24,31,226,150,183,0,4,66,38,57,6,128,1,26,129,80,33,27,
  4,0,16,70,111,114,119,97,114,100,32,83,112,101,101,100,0,4,66,52,
  57,6,128,1,26,129,84,48,21,4,0,16,84,117,114,110,32,83,112,101,
  101,100,0,3,126,26,39,11,132,1,24,3,126,43,40,11,132,1,24,129,
  135,21,24,4,0,16,70,111,114,119,97,114,100,32,71,101,97,114,0,129,
  138,38,18,4,0,16,84,117,114,110,32,71,101,97,114,0,1,171,42,9,
  9,0,1,31,83,0,1,171,29,9,9,0,12,31,67,0,67,66,63,54,
  11,101,37,8,11,67,79,20,29,10,101,37,8,11 };
...
struct {
  ...
  uint8_t complete; // =1 if button pressed, else =0
    ...
    // output variables
  char serialData[11]; // string UTF8 end zero
  char serialDataVal[11]; // string UTF8 end zero
