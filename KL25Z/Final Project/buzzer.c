...
void initPWM(void) { 
    ...
    // Configure PTB1 as TPM1_CH1 (Alt function 3 for PWM) 
    PORTB -> PCR[PTB1_Pin] &= ~PORT_PCR_MUX_MASK;  // Clear MUX field for PTB1 
    PORTB -> PCR[PTB1_Pin] |= PORT_PCR_MUX(3);     // Set PTB1 to TPM1_CH1 
